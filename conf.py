...
BLOG_AUTHOR = "zuoquan"  # (translatable)
BLOG_TITLE = "SpaceTest"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://simanwhite.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://simanwhite.com/"
BLOG_EMAIL = "simanwhite@126.com"
BLOG_DESCRIPTION = "This is a test."  # (translatable)
